...
function About() {
  return (
    <main className="relative min-h-dvh overflow-hidden bg-background p-4 text-foreground sm:p-8">
      ...
      <div className="relative flex items-center justify-between"><Link to="/"><Button variant="outline" size="icon"><ArrowLeft /><span className="sr-only">Back to Active Chat</span></Button></Link><ThemeSwitcher /></div>
